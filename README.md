# Static Code Quality Profiling of LLM-Generated Code

A unified toolkit for evaluating the static code quality of Python programs generated by large language models. The repository integrates multiple automated analysis tools, including **Pylint**, **SonarQube**, and **Radon**, to characterize complementary dimensions of generated code such as coding-rule findings, structural complexity, maintainability, reliability-related findings, security-related findings, and code-size properties.

Rather than combining these measures into a single quality score, the toolkit preserves individual metrics to support multidimensional static quality analysis.

## Project Overview

This project provides a set of independent code quality checkers designed for large-scale evaluation of model-generated Python code. Each checker reads code snippets from JSON-formatted submission files, extracts executable Python programs, and applies a corresponding static analysis tool to produce structured evaluation results.

The toolkit is designed to support benchmark-scale experiments and comparative studies across models, datasets, difficulty levels, and other grouping criteria. By combining outputs from multiple static analysis tools, it enables a broader assessment of generated code beyond functional correctness alone.

The repository currently includes:

- **Pylint-based checking**, for convention, refactor, warning, and error findings
- **SonarQube-based checking**, for maintainability, reliability, and security-related issues
- **Radon-based checking**, for structural metrics such as cyclomatic complexity, Maintainability Index, code size, comments, blank lines, and function counts
